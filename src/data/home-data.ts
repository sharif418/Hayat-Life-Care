...
export const lightboxImages = [
  { src: '/images/wings/11.png', alt: 'Hayat Life Care Complex', category: 'Healthcare' },
  { src: '/images/wings/gallery_lobby.png', alt: 'Premium Reception & Waiting Area', category: 'Facilities' },
  { src: '/images/wings/06.png', alt: 'Modern Doctor Consultation Room', category: 'Healthcare' },
  { src: '/images/wings/04.png', alt: 'Advanced Pathology Laboratory', category: 'Healthcare' },
  { src: '/images/wings/gallery_pharmacy.png', alt: '24/7 Pharmacy', category: 'Retail' },
  { src: '/images/wings/03.png', alt: 'Hygienic Restaurant & Cafe', category: 'Dining' },
  { src: '/images/wings/gallery_supershop.png', alt: 'Super Shop & Daily Needs', category: 'Retail' },
  { src: '/images/wings/01.png', alt: 'Spacious Basement Paid Parking', category: 'Facilities' },
]
