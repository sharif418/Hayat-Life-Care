...
export const navLinks: NavLink[] = [
  ...
  { label: 'Ownership', href: '/investment', langKey: 'ownership', children: [
    { label: 'Why Choose Ownership', href: '/investment#why-partner', langKey: 'whyPartner' },
    { label: 'Shareholder Tiers', href: '/investment#tiers', langKey: 'shareholderTiers' },
  ...
  { label: 'Gallery', href: '/gallery', langKey: 'gallery', children: [
    { label: 'YouTube Channel', href: '/gallery#youtube', langKey: 'youtubeChannel' },
    { label: 'Owners', href: '/gallery#owners', langKey: 'ownersGallery' },
    { label: 'Event', href: '/gallery#events', langKey: 'eventsGallery' },
  ]},
...
export const floors = [
  {
    ...
    descBn: 'আধুনিক নজরদারি ও ভ্যালেট সেবা সহ নিরাপদ ও প্রশস্ত পেইড পার্কিং সুবিধা।',
    facilities: ['3 basements with 150+ paid parking spaces'],
    facilitiesBn: ['৩টি বেসমেন্টে ১৫০+ পেইড পার্কিং স্পেস'],
  },
  {
    id: 'ground',
    label: 'Ground Floor',
    image: '/images/wings/floor_level1.jpg',
    description: 'Hospital Emergency Floor.',
    descBn: 'হাসপাতালের জরুরি ফ্লোর।',
    facilities: ['Hospital Emergency Floor'],
    facilitiesBn: ['হাসপাতালের জরুরি ফ্লোর'],
  },
  {
    id: 'level1',
    label: 'Level 1',
    ...
    descBn: 'গ্রাউন্ড ফ্লোর রিটেইল হাব — মুদি থেকে ওষুধ, সবকিছু এক ছাদের নিচে।',
    facilities: ['Reception', 'Super Shop', 'Pharmacy', 'Optical Shop', 'Coffee Shop', 'ATM Booth'],
    facilitiesBn: ['রিসেপশন', 'সুপার শপ', 'ফার্মেসি', 'অপটিক্যাল শপ', 'কফি শপ', 'এটিএম বুথ'],
  },
  {
    id: 'level2',
    label: 'Level 2',
    ...
    descBn: 'খাবার, পানীয় এবং পারিবারিক বিনোদন অঞ্চল — বিশ্রাম ও আনন্দের জন্য ডিজাইন করা।',
    facilities: ['Restaurant', 'Juice Bar', "Kid's Amusement Park"],
    facilitiesBn: ['রেস্তোরাঁ', 'জুস বার', 'কিডস অ্যামিউজমেন্ট পার্ক'],
  },
  {
    id: 'level3',
    label: 'Level 3',
    ...
    descBn: 'উন্নত পরীক্ষা সক্ষমতা সহ ব্যাপক প্যাথোলজি ও ডায়াগনস্টিক ল্যাবরেটরি।',
    facilities: ['Common Diagnostic Floor', 'Pathology', 'Microbiology', 'Immunology & Serology', 'Biochemistry', 'Hematology', 'MRI', 'ECG', 'USG', 'X-Ray'],
    facilitiesBn: ['কমন ডায়াগনস্টিক ফ্লোর', 'প্যাথোলজি', 'মাইক্রোবায়োলজি', 'ইমিউনোলজি ও সেরোলজি', 'বায়োকেমিস্ট্রি', 'হেমাটোলজি', 'এমআরআই', 'ইসিজি', 'ইউএসজি', 'এক্স-রে'],
  },
  {
    id: 'level4',
    label: 'Level 4',
    ...
    descBn: 'মহিলা রোগীদের জন্য নির্ধারিত ও উৎসর্গীকৃত ডায়াগনস্টিক ফ্লোর।',
    facilities: ["Designated Female Diagnostic Floor"],
    facilitiesBn: ['নির্ধারিত মহিলা ডায়াগনস্টিক ফ্লোর'],
  },
  {
    id: 'level5',
    label: 'Level 5',
    ...
    descBn: 'বিশেষায়িত পরামর্শ ফ্লোর।',
    facilities: ['Specialized Hospital'],
    facilitiesBn: ['বিশেষায়িত হাসপাতাল'],
  },
  {
    id: 'level6',
    label: 'Level 6',
    ...
    descBn: 'অত্যাধুনিক ক্যান্সার ডায়াগনস্টিক।',
    facilities: ['Specialized Hospital', 'Cancer Institute - PET CT Scan'],
    facilitiesBn: ['বিশেষায়িত হাসপাতাল', 'ক্যান্সার ইনস্টিটিউট - PET CT স্ক্যান'],
  },
  {
    id: 'level7',
    label: 'Level 7',
    ...
    descBn: 'বিশ্বমানের প্রজনন সেবা ও কাউন্সেলিং প্রদানকারী উৎসর্গীকৃত ফার্টিলিটি ইনস্টিটিউট।',
    facilities: ['Specialized Hospital', 'Fertility Institute'],
    facilitiesBn: ['বিশেষায়িত হাসপাতাল', 'ফার্টিলিটি ইনস্টিটিউট'],
  },
  {
    id: 'level8',
    label: 'Level 8',
    ...
    descBn: 'চক্ষু ও দন্ত সার্জারির জন্য শীর্ষ-তলা বিশেষজ্ঞ কেন্দ্র।',
    facilities: ['Specialized Hospital', 'Ophthalmology', 'Dental / Oral & Maxillofacial Surgery'],
    facilitiesBn: ['বিশেষায়িত হাসপাতাল', 'চক্ষুবিদ্যা', 'দন্ত / ওরাল ও ম্যাক্সিলোফেসিয়াল সার্জারি'],
  },
  {
    id: 'level9',
    label: 'Level 9',
    ...
    descBn: 'উৎসর্গীকৃত নামাজের স্থান ও কর্পোরেট অফিস।',
    facilities: ["Mosque (Male & Female)", "Office"],
    facilitiesBn: ['মসজিদ (পুরুষ ও মহিলা)', 'অফিস'],
  },
  {
    id: 'above9',
    label: 'Above Level 9',
    ...
    descBn: 'উন্নত বিশেষায়িত হাসপাতাল সুবিধাসমূহ।',
    facilities: [
    ...
    facilitiesBn: [
      'বিশেষায়িত ক্যান্সার হাসপাতাল',
      'বিশেষায়িত হৃদরোগ হাসপাতাল',
      'বিশেষায়িত কিডনি হাসপাতাল',
      'গাইনোকোলজি ও প্রসূতিবিদ্যা'
    ],
  },
]
...
export const faqs = [
  // General (1-8)
  { q: 'What is Hayat Life Care?', a: 'Hayat Life Care is a one-stop lifestyle destination set to become the largest diagnostic and specialized hospital center in Chattogram. It offers a cancer diagnostic center and a super specialized hospital in the city, along with a combination of healthcare, daily essentials, wellness, and leisure facilities — all under one roof.', category: 'general' },
  ...
  { q: 'What is the floor-wise plan?', a: 'Basement: 3 basements with 150+ parking spaces | Level 1: Reception, Super Shop, Pharmacy, Optical Shop, Coffee Shop & ATM Booth | Level 2: Restaurant, Juice Bar & Amusement Park | Level 3: Common Diagnostic Floor (Pathology, MRI, ECG, USG, X-Ray) | Level 4: Designated Female Diagnostic Floor | Level 5-8: Doctor\'s Chambers, Cancer Institute, Fertility Institute, Ophthalmology, Dental | Level 9: Mosque (Male & Female) & Office | Above Level 9: Super specialized Hospital (Cancer, Heart, Kidney, Gynecology & Obstetrics)', category: 'operations' },
  ...
  // Investment (9-16)
  { q: 'Why should you be a partner of Hayat Life Care?', a: 'One-time investment, lifetime returns. Combined income and healthcare benefits. Secure investment with full ownership (Land, Building, Equipment). High and sustainable Halal income. No bank loan involved. Cancer diagnostic center in the city. Super specialized hospital in the city. Largest diagnostic center in Chattogram. Unique concept in Bangladesh combining healthcare and lifestyle. Integrated facilities: Restaurants, Supermarkets, Amusement areas, cafés, ATM booths, and parking. 150+ car parking spaces. Prime location with high visibility. 11 business wings under one roof with single management.', category: 'investment' },
  { q: 'Why invest in Hayat Life Care?', a: 'Largest diagnostic and consultation center in Chattogram. Cancer diagnostic center and Super Specialized Hospital in the city. Unique concept combining healthcare and lifestyle. Includes restaurants, supermarkets, amusement parks, cafés, ATM booths. 150+ car parking spaces. Prime location with high visibility. 11 business wings under one roof with single management.', category: 'investment' },
...
export const lightboxImages = [
  ...
  { src: '/images/wings/floor_level4.jpg', alt: 'Female Diagnostic Floor', category: 'Healthcare' },
  { src: '/images/wings/floor_level6.jpg', alt: 'Oncology Diagnostics & PET CT', category: 'Healthcare' },
  { src: '/images/wings/floor_level7.jpg', alt: 'Fertility Institute', category: 'Healthcare' },
  { src: '/images/wings/floor_level8.jpg', alt: 'Ophthalmology & Dental Surgery', category: 'Healthcare' },
  { src: '/images/wings/floor_level9.jpg', alt: 'Prayer Area & Corporate Offices', category: 'Facilities' },
]
