    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-3 lg:px-4 h-16 md:h-20 flex items-center justify-between w-full relative">
          ...
          <a
            href="/"
            className={`flex items-center shrink-0 relative group rounded-2xl px-2 lg:px-3 py-2 -ml-2 lg:-ml-3 transition-all duration-300 ${scrolled
            ...
            {navLinks.map((link) => {
              ...
              return (
                <div key={link.label} className="relative group">
                  <a
                    href={link.href}
                    className={`relative px-1 md:px-1.5 lg:px-3 xl:px-4 py-2 text-[12px] md:text-[13px] lg:text-[14px] xl:text-[15px] uppercase tracking-wider lg:tracking-widest font-bold font-outfit rounded-lg transition-all duration-300 flex items-center gap-0.5 lg:gap-1 ${isActive
          ...
          <div className="md:hidden flex items-center gap-1.5 ml-auto">
            ...
            <button
              className={`rounded-full h-8 w-8 flex items-center justify-center transition-all duration-300 shadow-sm border ${scrolled
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              <SheetTrigger asChild>
                <button
                  ...
                  className={`rounded-xl h-9 w-9 flex items-center justify-center transition-all duration-300 shadow-sm border ${scrolled
