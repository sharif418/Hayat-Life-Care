...
const EXTRA_KEYWORD_ENTRIES = [
  ...
  { q: 'Who is leading Hayat Life Care?', keywords: ['leading', 'chairman', 'who leads', 'চেয়ারম্যান'], a: 'The project is led by Chairman Capt. Md Showkat Hossain Chowdhury and Managing Director Dr. Mohammad Azizul Haque, along with founding directors.' },
  ...
  { q: 'Who is the Managing Director?', keywords: ['managing director', 'md', 'azizul', 'ব্যবস্থাপনা পরিচালক'], a: 'Dr. Mohammad Azizul Haque — the Founder Director of Park View Hospital, Ekhusey Hospital, Delta Hospital and Treatment Hospital in Chattogram. He also serves as an Associate Professor at Chattogram Medical College & Hospital. A firm advocate of quality healthcare, Dr. Aziz leads by example and offers valuable guidance to foster excellence in clinical practice and hospital management.' },
  { q: 'Who are the Founding Directors?', keywords: ['founding director', 'founding directors', 'founder director', 'founder directors', 'founders', 'প্রতিষ্ঠাতা পরিচালক'], a: 'The Founding Directors of Hayat Life Care are: Capt. Md Showkat Hossain Chowdhury, Dr. Md Abu Naser, Md Abu Bakkar Siddiki, Capt. Atique UA Khan, Md Iqbal Hossain, Md Sayed Noor, Md. Helal Uddin Kawsar, Eng. Joinul Abeddin, and Ashekunnabi Mahmudur Rahman Mazumder.' },
  { q: 'How many members/directors will be in the Management Committee?', keywords: ['management committee', 'how many directors', 'members', 'committee', 'কমিটি'], a: 'The committee may consist of 13–17 members. There will be a group of highly skilled professionals similar to organizations like Unilever, GSK, and Standard Chartered who will mainly operate the organization.' },
  { q: 'How will profit be distributed?', a: 'Profit will be distributed monthly to shareholders based on their share proportion after full operation begins and annually in the AGM.', keywords: ['profit', 'distribution', 'dividend', 'return', 'earning', 'মুনাফা', 'লাভ'] },
  ...
  { q: 'How is the 10% profit determined?', keywords: ['10%', 'ten percent', 'profit determined', 'how much distribute'], a: 'Based on financial studies and industry surveys, the actual figure is higher than this. 10% is considered as the distributable profit to the shareholders.' },
  ...
  { q: 'Will there be registration in my name?', keywords: ['registration name', 'my name', 'নামে রেজিস্ট্রেশন'], a: 'For a company, all assets are always registered under the company name. All shareholders, including founder directors, are the combined owners of the spaces including land proportionately. So, you will not get the registration but you are an owner.' },
  ...
  { q: 'When will construction start?', keywords: ['construction start', 'begin', 'নির্মাণ শুরু'], a: 'After LUC approval from CDA.' },
  ...
  { q: 'Where is the project location?', keywords: ['project location', 'exact location', 'প্রকল্পের অবস্থান'], a: 'Corner plot of O.R. Nizam Road & Badsha Mia Road (War Cemetery Road), Chattogram. West of Chattogram Medical College and Hospital (CMCH), opposite CSCR.' },
  { q: 'What is the floor size?', keywords: ['floor size', 'sft', 'square feet', 'ফ্লোর সাইজ'], a: 'Approximately 19,000 sft per floor. Approximately 266,000 sft up to the 14th level.' },
  { q: 'When will revenue start?', keywords: ['revenue start', 'income start', 'earning start', 'আয় শুরু'], a: 'Revenue generation: December 2028 (+9 months) | Diagnostic operations start: June 2029 (+9 months) | Full diagnostic operations: December 2029 (+9 months) | Hospital operations: March 2030 (+9 months)' },
  { q: 'Why should you be a partner of Hayat Life Care?', keywords: ['why partner', 'why join', 'be a partner', 'পার্টনার কেন'], a: 'One-time investment, lifetime returns. Combined income and healthcare benefits. Secure investment with full ownership. High and sustainable Halal income. No bank loan involved. First cancer diagnostic center in the city. First specialized hospital in the city. Largest diagnostic center in Chattogram. 150+ car parking spaces. 11 business wings under one roof.' },
];
