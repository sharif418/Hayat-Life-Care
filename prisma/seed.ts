...
async function main() {
  ...
  const servicesData = [
    {
      title: 'Parking Zone',
      slug: 'parking-zone',
      description: 'Spacious and secure parking facility spread across 2 basement levels, providing convenient access for all visitors and tenants. The parking area is designed with modern safety systems, CCTV surveillance, and automated entry/exit for a hassle-free experience.',
      icon: 'Car',
  ...
  const faqsData = [
    ...
    },
    {
      ...
      answer: 'The Hayat Life Care complex is built on 55 Katha of land with an 8+ storied building featuring 2 basement levels.',
      category: 'general',
      order: 3,
      active: true,
    },
    {
      ...
      answer: 'The 11 business wings are: 1) Parking Zone, 2) ATM Booth, 3) Pharmacy, 4) Optical Shop, 5) Super Shop, 6) Coffee Shop, 7) Juice Bar, 8) Restaurant, 9) Children Amusement Park, 10) Doctor\'s Chamber, 11) Diagnostic Center.',
      category: 'general',
      order: 4,
      active: true,
    },
    ...
    },
    {
      ...
      answer: 'Yes, Hayat Life Care has spacious and secure parking facilities spread across 2 basement levels with CCTV surveillance and automated entry/exit systems.',
      category: 'general',
      order: 12,
      active: true,
    },
